        ...
        <div className="w-full lg:w-1/3 flex flex-col gap-6 justify-end">
          <div className="hud-border p-4 rounded-xl flex flex-col gap-2 bg-cyan-950/10">
             ...
             <div className="grid grid-cols-2 gap-2">
               <button onClick={() => setInputValue('SEARCH LATEST NEWS')} className="text-[10px] text-left border border-cyan-500/40 p-2 bg-cyan-500/10 hover:bg-cyan-500/30 transition rounded uppercase font-bold text-white shadow-lg">WEB_SEARCH</button>
               ...
               <button onClick={() => setInputValue('OPEN GOOGLE')} className="text-[10px] text-left border border-cyan-500/20 p-2 hover:bg-cyan-500/10 transition rounded uppercase font-bold">OPEN_GOOGLE</button>
             </div>
          </div>
